  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial' }}>
        ...
        <div style={{ padding: '20px', border: '1px solid #007bff', borderRadius: '5px', backgroundColor: '#e3f2fd' }}>
            <h2>{timerCount}</h2>
            <button onClick={handleStart} style={{ padding: '10px 20px', fontSize: '16px', marginRight: '10px', backgroundColor: '#4CAF50', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                Start
            </button>
            <button onClick={handleStop} style={{ padding: '10px 20px', fontSize: '16px', backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                Stop
            </button>
        </div>
    </div>
